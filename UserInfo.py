import pymysql
mysqldb=pymysql.connect(host="localhost",user="root",password="root",database="library")#established connection between your database  
mycursor=mysqldb.cursor()#cursor() method create a cursor object
def user_info():
    while True:  
      try:
          mycursor.execute("select user_id,user_name,number_of_books_taken,total_fine from user")#Execute SQL Query to select all record   
